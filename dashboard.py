...
class IMS:
    def __init__(self,root):
        ...
        LeftMenu=Frame(self.root,relief=RIDGE,bg="white")
        ...
        lbl_footer=Label(self.root,text="IMS-Inventory Management System\nFor any Technical Issue Contact: 98XXXXXX21",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.lbl_clock.place(x=0,y=70,relwidth=1,height=30)
        self.update_content()
