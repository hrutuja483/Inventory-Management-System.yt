...
class salesClass:
    def __init__(self,root):
        ...
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),bg="lightyellow").place(x=160,y=100,width=180)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area ",font=("goudy old style",30),bg="orange",).pack(side=TOP,fill=X)
